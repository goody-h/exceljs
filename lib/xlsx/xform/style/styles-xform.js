...
StylesXform.STATIC_XFORMS = {
  ...
  tableStyles: new StaticXform({
    tag: 'tableStyles',
    $: {count: 3, defaultTableStyle: 'TableStyleMedium2', defaultPivotStyle: 'PivotStyleLight16'},
    c: [
      {
        tag: 'tableStyle',
        $: {name: 'DegreeResult Style', pivot: 0, count: 2},
        c: [
          {tag: 'tableStyleElement', $: {type: 'wholeTable', dxfId: 1}},
          {tag: 'tableStyleElement', $: {type: 'headerRow', dxfId: 0}},
        ],
      },
      {
        tag: 'tableStyle',
        $: {name: 'ResultSummary Style', pivot: 0, count: 3},
        c: [
          {tag: 'tableStyleElement', $: {type: 'wholeTable', dxfId: 1}},
          {tag: 'tableStyleElement', $: {type: 'headerRow', dxfId: 0}},
          {tag: 'tableStyleElement', $: {type: 'firstRowStripe', dxfId: 2}},
        ],
      },
      {
        tag: 'tableStyle',
        $: {name: 'SpreadSheet Style', pivot: 0, count: 3},
        c: [
          {tag: 'tableStyleElement', $: {type: 'wholeTable', dxfId: 1}},
          {tag: 'tableStyleElement', $: {type: 'headerRow', dxfId: 0}},
          {tag: 'tableStyleElement', $: {type: 'totalRow', dxfId: 0}},
        ],
      },
    ],
  }),
